UPDATE mt_company set company_name = 'PRECISE CLONE BEFORE NOON 21/10' WHERE company_code = 'PRECISE';
...
update global_config set property_value = '' where property_name = 'mailusername';
...
update mt_employee_glbl set email_address = 'larry.do@synergixtech.com' where employee_code is not null;
...
select * from mt_user;
select * from mt_user where lower(alias) like lower('%admin%'); --PD0361 ;